                ...
                {currentValue ? (
                    <div className="flex flex-col items-center">
                        <Link
                            ...
                            className="bg-[#1D76BC] text-white px-4 py-2 rounded-md hover:bg-[#1660a0] cursor-pointer"
                        >
                ...
                {canUploadReturnLabel && (
                    <div className="mt-2">
                        ...
                        <label
                            ...
                            className="inline-flex items-center justify-center px-3 py-1.5 text-sm bg-[#1D76BC] text-white rounded-md hover:bg-[#1660a0] cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                        >
            ...
            <div className="space-y-6">
                <div>
                    <Table className="border">
                        <TableHeader>
                            <TableRow>
                                <TableHead style={{ backgroundColor: '#1D76BC', color: 'white' }} colSpan={2}>Tracking & Return Tracking</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            <TableRow>
                                            ...
                                            {order.tracking ? (
                                                order.tracking_link ? (
                                                    <Link
                                                        ...
                                                        target="_blank"
                                                        className="text-[#1D76BC] underline font-bold cursor-pointer"
                                                    >
                                                        {order.tracking}
                                                    </Link>
                                                ) : (
                ...
                <div className="lg:w-[72%] space-y-6">
                                                ...
                                                <TableCell colSpan={2}>
                                                    <div className="flex">
                                                        <Button
                                                            ...
                                                            className="bg-[#267d5a] hover:bg-[#267d5a] text-white cursor-pointer flex items-center gap-2"
                            ...
                            <Table className="border">
                                {order.order_status == process.env.NEXT_PUBLIC_STATUS_REJECTED ? (
                                    <>
                                        <TableHeader>
                                            <TableRow>
                                                <TableHead style={{ backgroundColor: '#1D76BC', color: 'white' }}>Rejected By</TableHead>
                                                <TableHead style={{ backgroundColor: '#1D76BC', color: 'white' }}>Date</TableHead>
                                            </TableRow>
                                        </TableHeader>
                                        <TableBody>
                                            <TableRow>
                                    ...
                                    <>
                                        <TableHeader>
                                            <TableRow>
                                                <TableHead style={{ backgroundColor: '#1D76BC', color: 'white' }}>Approved By</TableHead>
                                                <TableHead style={{ backgroundColor: '#1D76BC', color: 'white' }}>Date</TableHead>
                                            </TableRow>
                                        </TableHeader>
                                        <TableBody>
                    ...
                    <div>
                        <Table className="border">
                            <TableHeader>
                                <TableRow>
                                    <TableHead style={{ backgroundColor: '#1D76BC', color: 'white' }} className="w-[85%]">
                                        Products
                                    </TableHead>
                                    <TableHead style={{ backgroundColor: '#1D76BC', color: 'white' }} className="w-[15%]">
                                        Quantity
                                    </TableHead>
                                </TableRow>
                            </TableHeader>
                ...
                <div className="lg:w-[28%] space-y-6">
                    <div>
                        ...
                        <Table className="border">
                            <TableHeader>
                                <TableRow>
                                    <TableHead style={{ backgroundColor: '#1D76BC', color: 'white' }} colSpan={2}>Status</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                <TableRow>
