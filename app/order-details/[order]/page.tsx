    ...
    const handleReject = async () => {
        ...
        try {
            ...
            setOrders(prev => prev.map(o => o.id === order.id ? {
                ...o, ...updateData,
                rejected_user: profile ? { id: profile.id, email: profile.email, firstName: profile.firstName || '', lastName: profile.lastName || '' } : undefined
            } : o));
                    ...
                    <div>
                        <Table className="border">
                            ...
                            <TableBody>
                                ...
                                <TableRow><TableCell className="w-[65%] font-semibold">Is this a competitive opportunity?</TableCell><TableCell className="w-[35%] border-l">{renderEditableCell("is_competitive", order.is_competitive, "opp_competitive")}</TableCell></TableRow>
