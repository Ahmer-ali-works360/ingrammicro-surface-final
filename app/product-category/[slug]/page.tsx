                                                                        ...
                                                                        {isProductInCart ? (
                                                                            <div className="flex flex-col items-center space-y-2">
                                                                                <button
                                                                                    ...
                                                                                    className="sm:px-4 px-3 sm:py-2.5 py-1.5 text-sm font-medium text-[#4e5050] border border-[#484a4a] rounded-sm cursor-pointer hover:bg-[#1570EF] hover:text-white hover:border-[#1570EF] transition-colors flex items-center justify-center gap-2"
                                                                                >
