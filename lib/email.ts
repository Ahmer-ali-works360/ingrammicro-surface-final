...
<div style="font-family: 'Inter', sans-serif; background-color:#ffffff; padding:30px 0;">
    ...
    `}).join('');
        ...
        return {
            subject: `Overdue Reminder - Order #${orderNumber} (${companyName}) | Ingram Micro Surface SURFACE`,
            ...
            Thank you for using Ingram Micro Ingram Micro Surface! We hope your experience was very positive.

            Your order for ${companyName} is now due for return. 
            You can view your return label using the link below or request it via email at support@ingrammicro-.com:
            ...
            If you have any questions, please contact us at support@ingrammicro-.com.
